...
readMoneyText.prototype.doc = function (SoTien) {
  var lan = 0;
  var i = 0;
  var so = 0;
  var KetQua = "";
  ...
  if (soAm) {
    return "Âm " + KetQua + "đồng chắn";//.substring(0, 1);//.toUpperCase();// + KetQua.substring(1);
  }
  else {
