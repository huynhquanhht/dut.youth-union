<template>
  <div class="union-textbook-table-wrapper">
    <v-data-table
      v-model="selected"
      :headers="headers"
...
export default {
  ...
  methods: {
    ...
    checkSubmission(student) {
      console.log(student);
      this.changedUnionTextbook.set(student.union_textbook.id, student.union_textbook.submitted);
    },
    save() {
      this.command = 'Save';
