...
export default {
  ...
  computed: {
    ...mapGetters({
      pointList: 'getPointListOfCurrentStudent',
    }),
  },

  methods: {
    ...mapActions({
      fetchGetPointListOfCurrentStudent: 'fetchGetPointListOfCurrentStudent',
    }),
    ...mapMutations({
